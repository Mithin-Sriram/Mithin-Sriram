## Hi there 👋
# <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"> Hey, I'm Mithin Sriram!
...
<a href="https://github.com/Mithin-Sriram">
...
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| 🛡️ JanSuraksha       | Emergency response platform featuring SOS location sharing, multilingual safety guidance, emergency QR profiles and memory-based safety features. | Python, JavaScript, HTML, CSS, APIs |
| 🚀 Future AI Projects | Building AI-powered solutions focused on solving real-world problems and creating meaningful impact.                                              | AI, ML, Data Science                |
...
<!--
**Mithin-Sriram/Mithin-Sriram** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
